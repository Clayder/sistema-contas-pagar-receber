    ...
    <div class="">
        <div class="page-title">
            ...
            <div class="title_right">
                <a class="btn btn-app button-topo-info" title="Listar contas a pagar"
                   href="<?php echo url("ContaPagar", "index"); ?>">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_content">
                    ...
                    <div class="x_content">
                        <br/>
                        <form action="<?= url("contaPagar", "realizarEdicao"); ?>" method="POST" data-parsley-validate
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" name="vencimento" value="<?php echo $conta->vencimento; ?>"
                                           id="vencimento" class="form-control col-md-7 col-xs-12" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" name="valor" value="<?php echo convertMonetario("monetario",$conta->valor); ?>" id="valor"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="fkCategoria" class="form-control">
                                        <option selected=""
                                                value="<?= $conta->idCategoria; ?>"><?= $conta->categoria; ?></option>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pago">Pago: <span
                                            class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="pago" class="form-control">
                                        <option selected=""
                                                value="<?= $conta->pago; ?>"><?php echo ($conta->pago == 0) ? "Não" : "Sim"; ?></option>
