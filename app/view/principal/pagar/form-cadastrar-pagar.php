        ...
        <div class="page-title">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_content">
                    ...
                    <div class="x_content">
                        <br/>
                        <form action="<?= url("contaPagar", "realizarCadastro"); ?>" method="POST" data-parsley-validate
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" name="vencimento" value="" id="vencimento"
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button type="button" class="btn btn-success inserirDesconto" title="Adicionar desconto">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cliente">Cliente: <span
                                            class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                    ...
                                    <button type="submit" class="btn btn-success inputButton">Cadastrar</button>
                                </div>
                            </div>
                        </form>
                    </div>
