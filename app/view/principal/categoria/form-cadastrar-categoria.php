    ...
    <div class="page-title">
      ...
      <div class="clearfix"></div>
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_content">
            <?php flashDataMs('cadastrarCategoriaValid'); ?>
            <?php flashDataMs('cadastrarCategoria'); ?>
            <div class="x_content">
              <br />
              <form action="<?= url("categoria", "realizarCadastro"); ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
