      ...
      <div class="clearfix"></div>
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_content">
            ...
            <div class="x_content">
              <br />
              <form action="<?= url("contaReceber", "realizarEdicao"); ?>" method="POST" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="date" name="dataRecebimento" value="<?php echo $conta->dataRecebimento; ?>" id="dataRecebimento"  class="form-control col-md-7 col-xs-12" required="required">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="recebido" class="form-control">
                      <option selected="" value="<?= $conta->recebido; ?>"><?php echo ($conta->recebido == 0) ? "Não" : "Sim"; ?></option>
