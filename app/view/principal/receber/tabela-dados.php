...
<table id="datatable-buttons" class="table table-striped table-bordered">
  ...
  <tbody>
    <?php foreach ($contasReceber as $conta): ?>
      <tr>
        ...
        <td>
          <?php if ($conta->recebido == 0): ?>
              <p> Não </p>
              <form action="<?php echo url("ContaReceber", "efetuarRecebimento"); ?>" method="POST" onsubmit="return confirm('Você realmente deseja efetuar o recebimento ?')">
        ...
        <td>
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal<?php echo $conta->id; ?>">
      ...
      <!-- Modal -->
      <div class="modal fade" id="myModal<?php echo $conta->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
